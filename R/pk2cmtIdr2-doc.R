##' pk2cmtIdr2 RxODE model
##'
##' @format An \emph{RxODE} model with 26 parameters, 3 ODE states, and 5 calc vars.
##'
##'\emph{Parameters (pk2cmtIdr2$params)}
##'
##' \describe{
...
##' }
##'
##' \emph{Calculated Variables pk2cmtIdr2$lhs}
##'
##' \describe{
##'   \item{cp}{}
##'   \item{Imax}{}
