...
.buildModels <- function(){
    ## Adapted from https://github.com/metrumresearchgroup/mrgsolve/blob/9ff7240da48ec133635a6f0db2143f13623f0aff/inst/models/pbpk.cpp
    message("Jones2013")
    Jones2013 <- RxODE::RxODE({
