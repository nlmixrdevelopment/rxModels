...
extern SEXP rxModels_pk1cmt_model_vars(){
  ...
  SET_STRING_ELT(lhs,0,mkChar("cp"));
    ...
    SET_STRING_ELT(mmd5,0,mkChar("9440f5bb2472282aec878e6a7944de62"));
    SET_STRING_ELT(mmd5n,1,mkChar("parsed_md5"));
    SET_STRING_ELT(mmd5,1,mkChar("9440f5bb2472282aec878e6a7944de62"));
