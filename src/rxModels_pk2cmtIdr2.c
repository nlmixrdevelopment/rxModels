...
void rxModels_pk2cmtIdr2_dydt(int *_neq, double __t, double *__zzStateVar__, double *__DDtStateVar__)
{
  int _cSub = _neq[1];
...
void rxModels_pk2cmtIdr2_calc_jac(int *_neq, double __t, double *__zzStateVar__, double *__PDStateVar__, unsigned int __NROWPD__) {
  int _cSub=_neq[1];
  double t = __t + _solveData->subjects[_neq[1]].curShift;
  (void)t;
...
void rxModels_pk2cmtIdr2_calc_lhs(int _cSub, double __t, double *__zzStateVar__, double *_lhs) {
...
double rxModels_pk2cmtIdr2_F(int _cSub,  int _cmt, double _amt, double __t, double *__zzStateVar__){
 return _amt;
}
// Functional based absorption lag
double rxModels_pk2cmtIdr2_Lag(int _cSub,  int _cmt, double __t){
...
double rxModels_pk2cmtIdr2_Rate(int _cSub,  int _cmt, double _amt, double __t){
...
double rxModels_pk2cmtIdr2_Dur(int _cSub,  int _cmt, double _amt, double __t){
...
void rxModels_pk2cmtIdr2_ME(int _cSub, double _t, double __t, double *_mat, const double *__zzStateVar__){
   double t = __t + _solveData->subjects[_cSub].curShift;
  (void)t;
  }
// Inductive linearization Matf
void rxModels_pk2cmtIdr2_IndF(int _cSub, double _t, double __t, double *_matf){
   double t = __t + _solveData->subjects[_cSub].curShift;
  (void)t;
  }
...
SEXP matLst = PROTECT(allocVector(VECSXP, 0));pro++;
 SET_VECTOR_ELT(lst,  17, matLst);
    ...
    SET_STRING_ELT(mmd5,1,mkChar("50621f4092f11f8c0d4969aec27c2d3b"));
    ...
    SET_STRING_ELT(tran, 20,mkChar("rxModels_pk2cmtIdr2_ME"));
    SET_STRING_ELT(trann,21,mkChar("IndF"));
    SET_STRING_ELT(tran, 21,mkChar("rxModels_pk2cmtIdr2_IndF"));
...
extern int rxModels_pk2cmtIdr2_dydt_liblsoda(double __t, double *y, double *ydot, void *data)
{
  int *neq = (int*)(data);
  rxModels_pk2cmtIdr2_dydt(neq, __t, y, ydot);
  return(0);
}
...
void R_init0_rxModels_pk2cmtIdr2(){
  ...
  R_RegisterCCallable("rxModels","rxModels_pk2cmtIdr2_ME", (DL_FUNC) rxModels_pk2cmtIdr2_ME);
  R_RegisterCCallable("rxModels","rxModels_pk2cmtIdr2_IndF", (DL_FUNC) rxModels_pk2cmtIdr2_IndF);
